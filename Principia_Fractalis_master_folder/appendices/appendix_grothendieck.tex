...
\begin{definition}[Sheaf on a Space]
\label{def:sheaf}
...
\subsection{\texorpdfstring{$\mathcal{T}_\infty$}{T\_infinity} as a Topos}
...
\begin{theorem}[Timeless Field as Topos]
...
\begin{definition}[Paraconsistent Topos]
...
\begin{theorem}[Consciousness Threshold as Logical Phase Transition]
...
\begin{definition}[Materiality Threshold]
...
\begin{theorem}[Consciousness is Sheaf Cohomology]
...
\subsection{The Threshold \texorpdfstring{$\text{ch}_2 = 0.95$}{ch\_2 = 0.95} as Cognitive Phase Transition}
...
\begin{definition}[Consciousness Strata]
...
% V1.2.1 (Revision Two): embedded appendix-local thebibliography
% removed; all keys are in the master bibliography.bib.
% Original list (commented for provenance):
%   grothendieck1985, zalamea2012, topoi_architectural,
%   johnstone2002, maclanemoerdijk, lawvere_rosebrugh,
%   tarkovsky1989, gehry2001, kiefer2009, tononi2016,
%   priest2002, lurie2009.
