...
(65 pages, the substrate's Clay-bundle-closure exhibition as a
single citable result readable by any scientist; rolled forward from
the original 2026-06-19 companion through the V2.6.1 hostile-referee
polish pass).
...
\begin{itemize}
  ...
  \item \textbf{Companion paper (current)}:
    ...
    2026-06-23.tex} (65 pp, the substrate's Clay-bundle-closure
    exhibition; rolled forward from the original 2026-06-19 companion).
\end{itemize}
