...
companion paper is currently
\texttt{Papers/principia\_fractalis\_clean\_2026-06-23.tex}
(8 pages, the substrate's exposition paper; the longer
hostile-referee-defended exhibition paper has been retired to
\texttt{ARCHIVE/2026-06-24-bait-paper-retired/} per the
one-paper directive).
...
\begin{itemize}
  ...
  \item \textbf{Companion paper (current)}:
    \texttt{Papers/principia\_fractalis\_clean\_\\
    2026-06-23.tex} (8 pp, the substrate's exposition paper;
    the longer hostile-referee-defended exhibition is retired
    to \texttt{ARCHIVE/2026-06-24-bait-paper-retired/}).
\end{itemize}
