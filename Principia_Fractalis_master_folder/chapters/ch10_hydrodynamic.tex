...
Critical parameter & $\text{Re}_c \approx 3.28 \times 10^5$ (corrected 2026-05-18, see eq.~\eqref{eq:re-c-crit-correct}) & $\Lambda_{\text{QCD}} = 197.2 \text{ MeV}$ (canonical PDG value used in Ch~\ref{ch:yang-mills}; prior $213$ was wrong) \\
\bottomrule
\end{tabular}
\end{center}
