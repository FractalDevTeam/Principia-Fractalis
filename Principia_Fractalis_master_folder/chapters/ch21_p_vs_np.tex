...
\begin{warning}[Honest scope (substrate-level reading)]
The substrate-level claims in this chapter must be read in conjunction with
the foundational honest-scope marker at Chapter 34A \S7
(\cref{sec:substrate-honest-scope}). The framework does \textbf{NOT}
discharge this Clay Millennium Problem at the literal mathlib tier required
by the Clay rules. The framework's claim is structural --- that the substrate
forces this axis as one of several coupled sub-stories --- not a Clay-prize
claim. Specific named typed residuals at the substrate level are preserved
openly. Triumphalist prose surviving from earlier drafts (e.g.\ ``Resolution''
labels, ``complete solution'' framings) reflects authorial enthusiasm and is
reconciled with the substrate-level reading at Chapter 34A \S7.
\end{warning}
...
\alpha_{NP} &= \phi + \frac{1}{4} \approx 1.86803398875 \quad \text{(corrected 2026-05-18; prior $1.86802398875$ was off in 5th decimal)}
\end{align}
...
\begin{equation}
\left|\frac{0.798635510}{0.847127424}\right| \approx 0.9427\ldots \quad \text{(corrected 2026-05-18; prior $0.5988$ was wrong, and $(\sqrt{5}-1)/3 \approx 0.4120$ also $\neq 0.5988$)}
\end{equation}
...
\lambda_0(H_{NP}) &\stackrel{?}{=} \frac{\pi(\sqrt{5}-1)}{30\sqrt{2}} \approx 0.0915 \quad \text{(corrected 2026-05-18; prior $0.1330222423419$ was wrong; does NOT match empirical $\approx 0.1330$)}
\end{align}
...
\frac{\pi(\sqrt{5}-1)}{30\sqrt{2}} &\approx 0.0915 \quad \text{(corrected 2026-05-18; prior $0.1330222423419$ was arithmetically wrong; does NOT match empirical $\lambda_0(H_{NP}) \approx 0.1330$)}
\end{align*}
