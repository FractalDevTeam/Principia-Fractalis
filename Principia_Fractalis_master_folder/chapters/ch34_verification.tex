...
# Available at: https://github.com/FractalDevTeam/Principia-Fractalis
...
\begin{center}
\texttt{https://github.com/FractalDevTeam/Principia-Fractalis}
\end{center}
...
(\texttt{REFEREE\_PROOF\_LEAN4LEAN\_AUDIT\_2026-06-04.md},
...
\texttt{[propext, Classical.choice, Quot.sound]} preserved across
...
\texttt{REFEREE\_PROOF\_REVIEW\_2026-06-04.md}. Initial review
...
\texttt{REFEREE\_PROOF\_CROSS\_REFERENCE\_AUDIT\_2026-06-04.md}
...
with \texttt{[propext, Classical.choice, Quot.sound]} only;
6 of 8 legacy L4L modules gated on documented API-drift gap.
Flagship \texttt{PrincipiaFractalisSubstrateTheorem}
