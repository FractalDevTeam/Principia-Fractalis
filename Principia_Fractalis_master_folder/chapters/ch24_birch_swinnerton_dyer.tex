...
reproduced by it.  What \emph{did} appear: the largest $|$eigenvalue$|$ is
monotone in rank at $\approx 2$ per rank ($0.319,\,2.575,\,4.484,\,6.489$),
which is the classical Mestre--Nagao phenomenon.  So the chapter's core
intuition --- that rank is spectrally readable from $a_p/p$ data --- has a
genuine numerical footprint, while the specific $\varphi/e$-multiplicity
formulation does not.  Details: \texttt{codex/CH24\_SPECTRAL\_TEST\_2026-07-28.md}.
\end{itemize}
