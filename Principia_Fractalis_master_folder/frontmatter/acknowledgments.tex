...
**Claude (Anthropic)**: Complex multi-step reasoning, LaTeX generation, formalization of intuitions. Claude 3.5 Sonnet and Claude 4 Sonnet handled tasks requiring sustained context and careful logic. Required "coercion" to overcome excessive caution, but ultimately delivered.
