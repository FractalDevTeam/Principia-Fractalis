...
| `PF_canonical/2_LEAN_SOURCE_CODE/`             | `PF_Lean4_Code/PF/` (canonical Lean 4 library; **0 project axioms**, 0 sorries, 5750 jobs clean — ZERO-AXIOM milestone, commit `72c0137`, 2026-05-20) |
