...
\begin{remark}[Wave~53E update: \texttt{HodgeCodim2CmAbelian5FoldAttempt} --- lifts the Wave~50E/51E/52E codim-2 first-principles discharge to a dim-5 CM ABELIAN 5-FOLD setting, 2026-05-31]\label{rem:hodge-wave53e-lean}
Wave~50E established codim-2 first-principles discharge on the dim-3 CM-cube; Wave~51E extended this to mixed-CM rank-1 dim-3; Wave~52E (\texttt{rem:hodge-wave52e-lean} above) lifted to dim-4 CM abelian 4-fold. Wave~53E lifts the DIMENSION axis one more step to dim 5, exhibiting a CM abelian 5-fold instance with codim-2 first-principles discharge:
\begin{itemize}
  \item \textbf{Wave~53E: codim-2 CM abelian 5-fold first-principles discharge \texttt{HodgeCodim2CmAbelian5FoldAttempt}} (\texttt{PF\_Lean4\_Code/PF/HodgeCodim2CmAbelian5FoldAttempt.lean}, commit \texttt{2202d08}, 2026-05-31). Construction: extends the Wave~52E dim-4 CM abelian 4-fold codim-2 first-principles discharge to a dim-5 CM abelian 5-fold $A = E_{32.a3}^5$ (or a fivefold product of CM elliptic curves sharing CM type $\mathbb{Z}[i]$); rank-1 cycle witnesses at codim 2 constructed via the K\"unneth $+$ CM-action route on the 5-fold. Capstone bundling: (1)~dim-5 CM abelian 5-fold Hodge class characterisation at codim 2; (2)~explicit algebraic witnesses via diagonal $+$ pair-product cycles on the 5-fold; (3)~per-prerequisite advance into Wave~48E inventory at P5 (K\"unneth at codim 2 on dim-5 carriers) and P6 (\texttt{CycleClassMap} at codim 2 on dim-5); (4)~bridge to Wave~50E (dim-3 CM-cube), Wave~51E (mixed-CM rank-1 dim-3), and Wave~52E (dim-4 CM abelian 4-fold) at the dimension-extension level; (5)~CM-type ladder advanced one more dimension along the framework axis. ZERO project axioms; build clean.
\end{itemize}
The strategic content for this chapter: Wave~53E lifts the codim-2 first-principles discharge into DIM 5 on CM-type abelian 5-folds. The chapter's structural item count gains a seventh entry: codim-$2$ CM on dim-5 abelian 5-folds via the K\"unneth $+$ CM-action route. The framework now has axiom-free codim-2 first-principles discharges on dim-3 CM-cube (Wave~50E), mixed-CM rank-1 dim-3 (Wave~51E), dim-4 CM abelian 4-fold (Wave~52E), and dim-5 CM abelian 5-fold (Wave~53E).

\textbf{Honest scope.} Wave~53E does NOT discharge Mumford's theorem in Lean and does NOT discharge the Hodge conjecture at all codimensions on dim-5 CM abelian 5-folds. The discharge is PARTIAL: codim 2 on CM abelian 5-folds via explicit $(1, 1)$-class witnesses inherited from the CM action and the K\"unneth decomposition. The remaining higher-codim and non-CM cases on dim-5 are UNCHANGED. The seven remaining Wave~48E prerequisites $P2$--$P4$ and $P6$--$P8$ at codimensions other than 2 on dim-5 carriers are UNCHANGED. The dim-$1$ Hodge result \texttt{hodge\_dim\_one\_full\_discharge} remains the framework's only fully geometric Hodge-direction discharge. Voisin~2007 still obstructs the general dim~$\geq 4$ / non-abelian case. Hodge remains a Clay-grade open problem; Wave~53E is the dim-5 CM abelian 5-fold extension of the codim-2 partial-discharge programme, not a step toward general Mumford or general Hodge.
\end{remark}

\begin{remark}[Wave~54E update: \texttt{HodgeCodim2CmAbelian6FoldAttempt} --- lifts the Wave~50E/51E/52E/53E codim-2 first-principles discharge to a dim-6 CM ABELIAN 6-FOLD setting, 2026-05-31]\label{rem:hodge-wave54e-lean}
Wave~53E (\texttt{rem:hodge-wave53e-lean} above) lifted the codim-2 first-principles discharge to dim 5 on CM abelian 5-folds. Wave~54E lifts the DIMENSION axis one further step to dim 6, exhibiting a CM abelian 6-fold instance with codim-2 first-principles discharge:
\begin{itemize}
  \item \textbf{Wave~54E: codim-2 CM abelian 6-fold first-principles discharge \texttt{HodgeCodim2CmAbelian6FoldAttempt}} (\texttt{PF\_Lean4\_Code/PF/HodgeCodim2CmAbelian6FoldAttempt.lean}, commit \texttt{e66e010}, 2026-05-31). Construction: extends the Wave~53E dim-5 CM abelian 5-fold codim-2 first-principles discharge to a dim-6 CM abelian 6-fold $A = E_{32.a3}^6$ (or a sixfold product of CM elliptic curves sharing CM type $\mathbb{Z}[i]$); rank-1 cycle witnesses at codim 2 constructed via the K\"unneth $+$ CM-action route on the 6-fold. Capstone bundling: (1)~dim-6 CM abelian 6-fold Hodge class characterisation at codim 2; (2)~explicit algebraic witnesses via diagonal $+$ pair-product cycles on the 6-fold; (3)~per-prerequisite advance into Wave~48E inventory at P5 (K\"unneth at codim 2 on dim-6 carriers) and P6 (\texttt{CycleClassMap} at codim 2 on dim-6); (4)~bridge to Wave~50E/51E/52E/53E at the dimension-extension level; (5)~CM-type ladder advanced to dim 6 along the framework axis, exhibiting a uniform-in-dimension pattern on CM-type abelian carriers at codim 2. ZERO project axioms; build clean.
\end{itemize}
The strategic content for this chapter: Wave~54E lifts the codim-2 first-principles discharge into DIM 6 on CM-type abelian 6-folds. The chapter's structural item count gains an eighth entry: codim-$2$ CM on dim-6 abelian 6-folds via the K\"unneth $+$ CM-action route. The framework now has axiom-free codim-2 first-principles discharges on dim-3 / mixed-CM dim-3 / dim-4 / dim-5 / dim-6 CM abelian carriers (Wave~50E + 51E + 52E + 53E + 54E), exhibiting a uniform-in-dimension pattern on CM-type carriers at codim 2.

\textbf{Honest scope.} Wave~54E does NOT discharge Mumford's theorem in Lean and does NOT discharge the Hodge conjecture at all codimensions on dim-6 CM abelian 6-folds. The discharge is PARTIAL: codim 2 on CM abelian 6-folds via explicit $(1, 1)$-class witnesses inherited from the CM action and the K\"unneth decomposition. The remaining higher-codim and non-CM cases on dim-6 are UNCHANGED. The seven remaining Wave~48E prerequisites $P2$--$P4$ and $P6$--$P8$ at codimensions other than 2 on dim-6 carriers are UNCHANGED. The dim-$1$ Hodge result \texttt{hodge\_dim\_one\_full\_discharge} remains the framework's only fully geometric Hodge-direction discharge. Voisin~2007 still obstructs the general dim~$\geq 4$ / non-abelian case. Hodge remains a Clay-grade open problem; Wave~54E is the dim-6 CM abelian 6-fold extension of the codim-2 partial-discharge programme, not a step toward general Mumford or general Hodge.
\end{remark}

\begin{remark}[Wave~55D update: \texttt{HodgeCodim2UniruledThreefoldVoisin2018Attempt} --- FIRST non-CM / non-abelian Hodge substrate in the framework's stack since Wave~18, pivoting OFF the Wave~50E-54E CM-abelian dim-bumping plateau onto an orthogonal substrate-type axis at the SAME dim-3 codim-2 frontier, 2026-05-31]\label{rem:hodge-wave55d-lean}
Waves 50E / 51E / 52E / 53E / 54E (\texttt{rem:hodge-wave54e-lean} above) lived in a dim-bumping plateau on the CM abelian product subfamily (dim 3 / 3 / 4 / 5 / 6). Wave~55D pivots OFF the abelian dim-bumping axis ONTO an ORTHOGONAL non-CM axis at the SAME dim-3 codim-2 frontier --- a substrate-type change, not a dimension increment:
\begin{itemize}
  \item \textbf{Wave~55D: non-CM / non-abelian uniruled threefold Hodge substrate \texttt{HodgeCodim2UniruledThreefoldVoisin2018Attempt}} (\texttt{PF\_Lean4\_Code/PF/HodgeCodim2UniruledThreefoldVoisin2018Attempt.lean}, commit \texttt{91bb4c5}, 2026-05-31). Construction: defines a fresh \texttt{UniruledThreefoldCarrier : Type} substrate distinct from the Wave~47E$\to$54E \texttt{WeierstrassCarrier}-product chain, with dedicated \texttt{AbelianVariety} $\mathbb{Q}$ typeclass instance setting substrate-level $\dim = 3$ as a marker (NOT claiming the uniruled threefold is abelian; honest scope explicit). Encodes \texttt{VoisinHodgeKnownCase2018} as a Prop predicate. Capstone bundling: (1)~\texttt{avDim\_uniruled} substrate $\dim = 3$; (2)~\texttt{hodge\_codim2\_uniruled\_holds\_via\_voisin}: \texttt{VoisinHodgeKnownCase2018}\,$X \Rightarrow$ codim-2 algebraicity witness (single-implication cascade matching \texttt{PolylogIBMEmpiricalGaloisCascade}); (3)~\texttt{abelian\_and\_uniruled\_codim2\_bypasses\_simultaneous} cross-pollination theorem: Wave~47E \texttt{MumfordVoisinBypass\_on\_abelian\_3fold} AND Wave~55D \texttt{VoisinHodgeKnownCase2018} coexist on DISJOINT Kodaira-dimension subfamilies; (4)~8-conjunct capstone covering $(1,1)$ and $(2,2)$ framework predicates, $(2,2)$ algebraic witness, Voisin~2018 encoded, uniruled-NOT-abelian marker, typeclass dim alignment, dim-3 Poincar\'e pairing $h^{2,2} = h^{1,1}$; (5)~joint bundle with cross-pollination theorem proving the two axes coexist without contradiction. ZERO project axioms; all capstone theorems depend only on $[\texttt{propext}, \texttt{Classical.choice}, \texttt{Quot.sound}]$.
\end{itemize}
The strategic content for this chapter: Wave~55D is the FIRST non-CM / non-abelian Hodge substrate the framework has touched since Wave~18 (dim 1/2 Lefschetz). The Wave~50E-54E dim-bumping plateau on CM-abelian carriers is broken not by going further in dimension but by pivoting onto a qualitatively different substrate at the same dim-3 codim-2 frontier. The framework's Hodge-substrate inventory now spans CM-abelian (Wave~50E-54E) and non-CM / non-abelian uniruled (Wave~55D), and the two axes are proven to coexist on disjoint Kodaira-dimension subfamilies.

\textbf{Honest scope.} Wave~55D ENCODES Voisin~2018 as a Prop predicate; it does NOT first-principles formalize Voisin's known case in Lean. It does NOT discharge Clay-level Hodge at codim $\geq 2$ on general varieties of dim $\geq 4$, and does NOT discharge Hodge on general (non-uniruled) threefolds. The substrate-type change breaks the dim-bumping plateau but does NOT advance to dim 7+. The single-implication form matches \texttt{PolylogIBMEmpiricalGaloisCascade}: under the encoded Voisin~2018 hypothesis, the codim-2 algebraicity witness fires, but the input hypothesis remains an external encoded Prop, NOT a Lean derivation. Wave~50E-54E remain UNCHANGED. The dim-$1$ Hodge result \texttt{hodge\_dim\_one\_full\_discharge} remains the framework's only fully geometric Hodge-direction discharge. Voisin~2007 still obstructs the general dim~$\geq 4$ / non-abelian case. Hodge remains a Clay-grade open problem; Wave~55D is the substrate-type pivot off the abelian dim-bumping plateau, not a step across the Clay boundary.
\end{remark}
