...
The (self-adjoint) symmetric operator $\widetilde{\mathcal{T}}_E$ of Theorem~\ref{thm:self-adjoint-bsd}, with $\alpha = 3\pi/4$, has spectral measure concentrating at
\begin{equation}
\lambda_* \;=\; \frac{\varphi}{e} \;=\; \frac{1 + \sqrt{5}}{2e} \;\approx\; 0.59634736\ldots
\end{equation}
