...
The combinatorial identity $\dim(E_6) = 78$ is independently verified algebraically in \texttt{PF\_Lean4\_Code/PF/Cosmology/E6ChernIndex78pi.lean} (axiom-free); auxiliary calculations identifying the $48 + 26 + 4$ split with the trinification decomposition are in Appendix~\ref{app:weinstein}.
\end{proof}
