...
\medskip
\noindent\emph{Numerical correction, 2026-05-18: Prior editions claimed $\pi/(10(\varphi+1/4)) \approx 0.1330222423$, equating the closed form to the empirical value. The formula $\pi/(10(\varphi+1/4))$ actually evaluates to $\approx 0.1682$, not $0.1330$. Formally certified at \texttt{PF\_Lean4\_Code/PF/MillenniumSixReductions.lean}, theorem \texttt{lambda\_0\_NP\_target\_closed\_bracket\_9digit} proves $0.168176418 < \pi/(10(\varphi+1/4)) < 0.168176419$. See Ch~\ref{ch:p-vs-np} Remark~\ref{rem:alpha-P-NP-derivation-status} for the three-way inconsistency between closed-form and empirical values.}

The empirical spectral gap is:
\begin{equation}
\Delta^{\text{emp}} = \lambda_0(H_P) - \lambda_0(H_{NP})^{\text{emp}} \approx 0.2221441469 - 0.1330222423 = 0.0891219046 > 0
\end{equation}
Therefore, conditional on the empirical $\lambda_0(H_{NP})$ measurement, \textbf{P $\neq$ NP}.
\end{theorem}
