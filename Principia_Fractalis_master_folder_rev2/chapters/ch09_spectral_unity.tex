...
\end{equation}
Therefore, conditional on the polylog spectral conjecture (Ch~\ref{ch:p-vs-np}, Conjecture \texttt{conj:polylog-spectrum}, axiomatized as \texttt{alpha\_class\_polylog\_eigenvalue\_conjecture}), \textbf{P $\neq$ NP}.
\end{theorem}
