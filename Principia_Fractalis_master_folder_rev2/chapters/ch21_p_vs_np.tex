...
\item Derive $\alpha_P = \sqrt{2}$ and $\alpha_{NP} = \varphi + 1/4$ from first principles (currently axiomatized as \texttt{alpha\_class\_polylog\_eigenvalue\_conjecture}; see Remark~\ref{rem:alpha-P-NP-derivation-status}).
\end{enumerate}
