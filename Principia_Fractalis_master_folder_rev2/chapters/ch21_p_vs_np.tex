...
\begin{equation}
\frac{\lambda_0(H_{NP})}{\lambda_0(H_P)} = \frac{0.1330222423}{0.2221441469} \approx 0.5988854382 \approx \frac{\sqrt{5}-1}{3}
\end{equation}

This implies the closed form:
\begin{equation}
\lambda_0(H_{NP}) = \frac{\pi(\sqrt{5}-1)}{30\sqrt{2}} \approx 0.1330222423419...
\end{equation}
