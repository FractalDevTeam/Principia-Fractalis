...
**Paper at HEAD**: `Papers/principia_fractalis_clean_2026-06-25.{tex,pdf}` (16 pages, 8 explanatory figures; rolled forward from `2026-06-24.{tex,pdf}` (16 pp) under the daily-filename-rollover rule. The 06-25 paper carries (on top of the 06-24 baseline): §3 strict-total-ordering paragraph surfacing the kernel-only chain `α_Poincaré < α_P < α_RH < α_Hodge < α_NP < α_YM < α_BSD < α_QG < α_NS`; Table 1 expanded with `λ_0` closed-forms and 4-decimal numerical brackets across all nine substrate classes; §4.4 cosmological-constant centerpiece with derivation chain figure; §4.4 cross-derivation paragraph for `c_2 = 0.95` (topological + operator-spectral). The longer hostile-referee-defended exhibition paper (`principia_fractalis_millennium_problems_2026-06-23`, 65 pp) has been retired to `ARCHIVE/2026-06-24-bait-paper-retired/`; the substrate's primary deliverable is now the single clean exposition paper.
