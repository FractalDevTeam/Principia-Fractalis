...
**Paper at HEAD**: `Papers/principia_fractalis_clean_2026-06-24.{tex,pdf}` (14 pages, 7 explanatory figures; rolled forward from `2026-06-23.{tex,pdf}` (8 pp) under the daily-filename-rollover rule. The 06-24 paper carries: the §3 α-skeleton supreme-receipt paragraph; the §4 look-elsewhere statistical retraction and the substrate-natural prior subsection; the §3 constructive-cascade and universal-coupling figures; the §4 IBM peaks and look-elsewhere disclosure figures; the §2 H₃ geometric-anchor figure; the §6 pre-registration timeline figure; the §7 axiom-chain figure; the rewritten abstract; the §1 section-map surfacing of §6; formal citations for Babai, Schöning, Goldwasser–Sipser, and Bourbaki; the §7 one-command `./verify.sh` incantation; and the appendix HEAD pin updated to the current HEAD). The longer hostile-referee-defended exhibition paper (`principia_fractalis_millennium_problems_2026-06-23`, 65 pp) has been retired to `ARCHIVE/2026-06-24-bait-paper-retired/`; the substrate's primary deliverable is now the single clean exposition paper.
