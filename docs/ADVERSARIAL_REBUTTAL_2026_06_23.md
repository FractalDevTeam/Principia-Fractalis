...
**Paper at HEAD**: `Papers/principia_fractalis_clean_2026-06-24.{tex,pdf}` (10 pages; rolled forward from `2026-06-23.{tex,pdf}` (8 pp) under the daily-filename-rollover rule, with the §3 α-skeleton supreme-receipt paragraph and the §4 look-elsewhere statistical retraction added). The longer hostile-referee-defended exhibition paper (`principia_fractalis_millennium_problems_2026-06-23`, 65 pp) has been retired to `ARCHIVE/2026-06-24-bait-paper-retired/`; the substrate's primary deliverable is now the single clean exposition paper.
