...
// Module: PF_L4L.Core.Zeta
// Imports: Init PF.RH_Equivalence Mathlib.NumberTheory.LSeries.RiemannZeta
#include <lean/lean.h>
...
LEAN_EXPORT lean_object* initialize_PF__L4L_Core_Zeta(uint8_t builtin, lean_object* w) {
lean_object * res;
