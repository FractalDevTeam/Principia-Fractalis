(*
  ...
  In this file: 26 proof obligations, of which 2 are `True` closed by
  `exact I` (no content) and 24 are closed with real tactics.
  Those 24 are UNAUDITED: individually each may be genuine arithmetic or
