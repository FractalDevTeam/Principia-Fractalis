(*
  ...
  In this file: 27 proof obligations, of which 2 are `True` closed by
  `exact I` (no content) and 25 are closed with real tactics.
  Those 25 are UNAUDITED: individually each may be genuine arithmetic or
