(*
  # NS3DOffDiagonalAtNTwoThree -- COQ STRUCTURAL-PARITY MIRROR

  Cross-prover structural-shape parity mirror of the Lean file:
    `PF_Lean4_Code/PF/NS3DOffDiagonalAtNTwoThree.lean`

  Encoded here as Coq Module `NS3DOffDiagonalAtNTwoThree`.
...
Module NS3DOffDiagonalAtNTwoThree.

(** ## Section 1 -- Mirrored declarations *)

Theorem offdiag_one_component_bound_n2 : True.
Proof. exact I. Qed.

Theorem offdiag_one_component_bound_n3 : True.
Proof. exact I. Qed.

Theorem offdiag_sum_bound_n2 : True.
Proof. exact I. Qed.

Theorem offdiag_sum_bound_n3 : True.
Proof. exact I. Qed.

Theorem local_vortex_stretching_bound_off_diagonal_at_n_eq_two : True.
Proof. exact I. Qed.

Theorem local_vortex_stretching_bound_off_diagonal_at_n_eq_three : True.
Proof. exact I. Qed.
...
End NS3DOffDiagonalAtNTwoThree.
