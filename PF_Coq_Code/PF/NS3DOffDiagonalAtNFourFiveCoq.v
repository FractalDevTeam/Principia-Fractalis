...
*)
(*
  # NS3DOffDiagonalAtNFourFive -- COQ STRUCTURAL-PARITY MIRROR

  Cross-prover structural-shape parity mirror of the Lean file:
    `PF_Lean4_Code/PF/NS3DOffDiagonalAtNFourFive.lean`

  Encoded here as Coq Module `NS3DOffDiagonalAtNFourFive`.
...
Module NS3DOffDiagonalAtNFourFive.

(** ## Section 1 -- Mirrored declarations *)

Theorem offdiag_one_component_bound_n4 : True.
Proof. exact I. Qed.

Theorem offdiag_one_component_bound_n5 : True.
Proof. exact I. Qed.

Theorem offdiag_sum_bound_n4 : True.
Proof. exact I. Qed.

Theorem offdiag_sum_bound_n5 : True.
Proof. exact I. Qed.

Theorem local_vortex_stretching_bound_off_diagonal_at_n_eq_four : True.
Proof. exact I. Qed.

Theorem local_vortex_stretching_bound_off_diagonal_at_n_eq_five : True.
Proof. exact I. Qed.

Theorem local_vortex_stretching_bound_off_diagonal_at_n_le_five : True.
Proof. exact I. Qed.
...
End NS3DOffDiagonalAtNFourFive.
