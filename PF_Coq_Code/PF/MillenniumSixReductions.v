(*
  ...
  In this file: 52 proof obligations, of which 0 are `True` closed by
  `exact I` (no content) and 52 are closed with real tactics.
  Those 52 are UNAUDITED: individually each may be genuine arithmetic or
