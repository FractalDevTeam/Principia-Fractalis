(*
  ...
  In this file: 27 proof obligations, of which 0 are `True` closed by
  `exact I` (no content) and 27 are closed with real tactics.
  Those 27 are UNAUDITED: individually each may be genuine arithmetic or
