(*
  ...
  In this file: 13 proof obligations, of which 1 are `True` closed by
  ...
  This file also declares 3 `Admitted.`/`Abort.` proof(s) and 3 `Axiom`/`Parameter`/`Hypothesis` stand-in(s).
