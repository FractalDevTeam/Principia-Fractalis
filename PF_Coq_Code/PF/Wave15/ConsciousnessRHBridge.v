(*
  ...
  In this file: 4 proof obligations, of which 1 are `True` closed by
  ...
  This file also declares 2 `Admitted.`/`Abort.` proof(s) and 7 `Axiom`/`Parameter`/`Hypothesis` stand-in(s).
