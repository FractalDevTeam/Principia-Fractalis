(*
  ...
  In this file: 40 proof obligations, of which 17 are `True` closed by
  `exact I` (no content) and 23 are closed with real tactics.
  Those 23 are UNAUDITED: individually each may be genuine arithmetic or
