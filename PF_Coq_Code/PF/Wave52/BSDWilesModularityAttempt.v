(*
  ...
  In this file: 30 proof obligations, of which 2 are `True` closed by
  `exact I` (no content) and 28 are closed with real tactics.
  Those 28 are UNAUDITED: individually each may be genuine arithmetic or
