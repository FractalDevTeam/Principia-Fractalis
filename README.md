...
| `Papers/principia_fractalis_clean_2026-06-27.{tex,pdf}` | The substrate's exposition paper (20 pp, 8 explanatory figures, three appendices: verbatim `#print axioms` snapshot, seventeen extended algebraic invariants, λ₀² closed-form spectrum + P/NP spectral-gap closed form) |
...
```bash
cd Papers
pdflatex principia_fractalis_clean_2026-06-27
pdflatex principia_fractalis_clean_2026-06-27
```
