#!/bin/bash
# c1_supervisor_v4.sh <scope> <root> <label> <boxk...>
#
...
ESCALATION=/tmp/r331b_logs/ESCALATION_${LABEL}.md
...
echo "SUPERVISOR_START $(date -Is) label=$LABEL scope=$SCOPE driver=a1_v3 boxes=$BOXES cap=$MAXTRY policy=escalate-on-repeat" >> "$LOG"
