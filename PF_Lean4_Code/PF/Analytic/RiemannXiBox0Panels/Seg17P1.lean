/-
# PF.Analytic.RiemannXiBox0Panels.Seg17P1
...
namespace PrincipiaTractalis.RiemannXiBox0Panels.Seg17P1
...
private theorem u0_re_adverse_ge :
  ...
  refine _root_.Interval.approx_le
    (-131331753/10000000000 : _root_.Interval)
...
theorem node_0_bounds (σ : ℝ)
    ...
    ((-131331753/10000000000 : ℝ)) ≤ realThetaReIntegrandN 3 σ 15 (1105/736 : ℝ)
...
private theorem u1_re_adverse_ge :
  ...
  rw [rpow_neg_eq_exp hu0, rpow_neg_eq_exp hu0, omegaPartial_3_closed]
  refine _root_.Interval.approx_le
    (-65096469/5000000000 : _root_.Interval)
    ((_root_.Interval.exp (-(_root_.Interval.log
...
theorem node_1_bounds (σ : ℝ)
    (hσ0 : (1 : ℝ)/2 ≤ σ) (hσ1 : σ ≤ 9/16) :
    ((-65096469/5000000000 : ℝ)) ≤ realThetaReIntegrandN 3 σ 15 (1107/736 : ℝ)
    ∧ realThetaReIntegrandN 3 σ 15 (1107/736 : ℝ) ≤ (0)
    ∧ ((0 : ℝ)) ≤ realThetaImIntegrandN 3 σ 15 (1107/736 : ℝ)
    ∧ realThetaImIntegrandN 3 σ 15 (1107/736 : ℝ) ≤ ((67/5000000 : ℝ)) := by
...
private theorem u2_re_adverse_ge :
  ...
  rw [rpow_neg_eq_exp hu0, rpow_neg_eq_exp hu0, omegaPartial_3_closed]
  refine _root_.Interval.approx_le
    (-32260053/2500000000 : _root_.Interval)
    ((_root_.Interval.exp (-(_root_.Interval.log
...
theorem node_2_bounds (σ : ℝ)
    (hσ0 : (1 : ℝ)/2 ≤ σ) (hσ1 : σ ≤ 9/16) :
    ((-32260053/2500000000 : ℝ)) ≤ realThetaReIntegrandN 3 σ 15 (1109/736 : ℝ)
...
theorem seg17_p1_chunk_bounds (σ : ℝ)
    (hσ0 : (1 : ℝ)/2 ≤ σ) (hσ1 : σ ≤ 9/16) :
    ((-390564903/10000000000 : ℝ)) ≤ realThetaReIntegrandN 3 σ 15 (1105/736 : ℝ) + realThetaReIntegrandN 3 σ 15 (1107/736 : ℝ) + realThetaReIntegrandN 3 σ 15 (1109/736 : ℝ)
    ...
    ∧ ((0/1 : ℝ)) ≤ realThetaImIntegrandN 3 σ 15 (1105/736 : ℝ) + realThetaImIntegrandN 3 σ 15 (1107/736 : ℝ) + realThetaImIntegrandN 3 σ 15 (1109/736 : ℝ)
    ∧ realThetaImIntegrandN 3 σ 15 (1105/736 : ℝ) + realThetaImIntegrandN 3 σ 15 (1107/736 : ℝ) + realThetaImIntegrandN 3 σ 15 (1109/736 : ℝ) ≤ ((201/5000000 : ℝ)) := by
...
end PrincipiaTractalis.RiemannXiBox0Panels.Seg17P1
