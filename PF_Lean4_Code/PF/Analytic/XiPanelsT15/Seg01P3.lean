/-
# PF.Analytic.XiPanelsT15.Seg01P3
...
theorem s01c09 : (0.0615268915 : ℝ)
    ≤ ∑ i ∈ Finset.range 1, nodeR15 (1.06125 + 0.0025 * (i : ℕ)) := by
  refine _root_.Interval.approx_le ((0.0615268915 : _root_.Interval))
    (nodeFold15 1 (1.06125 : _root_.Interval) (0.0025 : _root_.Interval))
    (0.0615268915 : ℝ) (∑ i ∈ Finset.range 1, nodeR15 (1.06125 + 0.0025 * (i : ℕ)))
    (by approx) (nodeFold15_mem 1 1.06125 0.0025 _ _ (by approx) (by approx)) ?_
  decide +kernel
