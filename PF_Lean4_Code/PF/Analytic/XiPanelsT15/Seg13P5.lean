/-
# PF.Analytic.XiPanelsT15.Seg13P5
...
theorem s13c17 : (-0.0000031351 : ℝ)
    ≤ ∑ i ∈ Finset.range 2, nodeR15 (3.97 + 0.02 * (i : ℕ)) := by
  refine _root_.Interval.approx_le ((-0.0000031351 : _root_.Interval))
    (nodeFold15 2 (3.97 : _root_.Interval) (0.02 : _root_.Interval))
    (-0.0000031351 : ℝ) (∑ i ∈ Finset.range 2, nodeR15 (3.97 + 0.02 * (i : ℕ)))
    (by approx) (nodeFold15_mem 2 3.97 0.02 _ _ (by approx) (by approx)) ?_
  decide +kernel
