/-
# PF.Analytic.XiPanelsT15.Seg02P3
...
theorem s02c09 : (0.034407927 : ℝ)
    ≤ ∑ i ∈ Finset.range 1, nodeR15 (1.12375 + 0.0025 * (i : ℕ)) := by
  refine _root_.Interval.approx_le ((0.034407927 : _root_.Interval))
    (nodeFold15 1 (1.12375 : _root_.Interval) (0.0025 : _root_.Interval))
    (0.034407927 : ℝ) (∑ i ∈ Finset.range 1, nodeR15 (1.12375 + 0.0025 * (i : ℕ)))
    (by approx) (nodeFold15_mem 1 1.12375 0.0025 _ _ (by approx) (by approx)) ?_
  decide +kernel
