/-
# PF.Analytic.XiPanelsT15.Seg08P3
...
theorem s08c09 : (-0.002727314 : ℝ)
    ≤ ∑ i ∈ Finset.range 1, nodeR15 (1.7475 + 0.005 * (i : ℕ)) := by
  refine _root_.Interval.approx_le ((-0.002727314 : _root_.Interval))
    (nodeFold15 1 (1.7475 : _root_.Interval) (0.005 : _root_.Interval))
    (-0.002727314 : ℝ) (∑ i ∈ Finset.range 1, nodeR15 (1.7475 + 0.005 * (i : ℕ)))
    (by approx) (nodeFold15_mem 1 1.7475 0.005 _ _ (by approx) (by approx)) ?_
  decide +kernel
