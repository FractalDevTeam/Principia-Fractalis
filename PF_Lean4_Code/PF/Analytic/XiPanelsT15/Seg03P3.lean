/-
# PF.Analytic.XiPanelsT15.Seg03P3
...
theorem s03c09 : (0.0121043473 : ℝ)
    ≤ ∑ i ∈ Finset.range 1, nodeR15 (1.18625 + 0.0025 * (i : ℕ)) := by
  refine _root_.Interval.approx_le ((0.0121043473 : _root_.Interval))
    (nodeFold15 1 (1.18625 : _root_.Interval) (0.0025 : _root_.Interval))
    (0.0121043473 : ℝ) (∑ i ∈ Finset.range 1, nodeR15 (1.18625 + 0.0025 * (i : ℕ)))
    (by approx) (nodeFold15_mem 1 1.18625 0.0025 _ _ (by approx) (by approx)) ?_
  decide +kernel
