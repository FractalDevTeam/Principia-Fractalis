...
Authors: Pablo Cohen
-/
import PF.ForMathlib.CfcMemTwoSidedIdeal
...
theorem continuousOn_indicator_one_of_isClopen {a : A} {U : Set ℝ}
  ...
  have h : (quasispectrum ℝ a).restrict (U.indicator (1 : ℝ → ℝ))
...
#print axioms CStarAlgebra.continuousOn_indicator_one_of_isClopen
#print axioms CStarAlgebra.spectralProjection
#print axioms CStarAlgebra.isSelfAdjoint_spectralProjection
#print axioms CStarAlgebra.isIdempotentElem_spectralProjection
#print axioms CStarAlgebra.spectralProjection_mem
#print axioms CStarAlgebra.spectralProjection_eq_zero_iff
#print axioms CStarAlgebra.spectralProjection_ne_zero
#print axioms CStarAlgebra.isClopen_of_finite_quasispectrum
#print axioms CStarAlgebra.spectralProjection_singleton_ne_zero
