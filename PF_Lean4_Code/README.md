...
This directory contains the Lean 4 formalization of the Principia Fractalis substrate-level Theory of Everything. The canonical entry point is the project root README at [`../README.md`](../README.md). The substrate's primary deliverable is the Millennium-problems Theory-of-Everything paper at [`../Papers/principia_fractalis_millennium_problems_2026-07-05.pdf`](../Papers/principia_fractalis_millennium_problems_2026-07-05.pdf); a back-pocket algebraic-skeleton-only exposition is at [`../Papers/principia_fractalis_clean_2026-06-29.pdf`](../Papers/principia_fractalis_clean_2026-06-29.pdf).

This file documents only the Lean-side build, layout, and headline theorems. For the substrate's full reach (consciousness, cosmology, Geometric Unity, etc.), see the book at `../Principia_Fractalis_master_folder/main.pdf` (V2.6.1, 918 pages; anchor commit pinned in the book's title page — later commits on `origin/master` may be newer, check `git log` for live HEAD).
