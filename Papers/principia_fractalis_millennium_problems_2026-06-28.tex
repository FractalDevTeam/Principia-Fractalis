...
\subsection{The forty-seven author-prior-work prior-work anchors}
...
\item \textbf{(P2) XENON-127 nuclear-transition anomaly}: $1 + (\pi/(\alpha_{\textsf{YM}}\cdot\alpha_{\textsf{HN}}))\cdot c_2$ matches the XENON $\Gamma/\Gamma_{\textsf{SM}}$ excess to within $0.5\%$~\cite{xenon-collab,xenon-2necec-124xe}.
...
\begin{itemize}[itemsep=2pt]
\item Forty-seven author-prior-work prior-work anchors across seven manuscripts and certifications;
