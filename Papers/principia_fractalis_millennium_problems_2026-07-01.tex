%% SUPERSEDED_BY: principia_fractalis_millennium_problems_2026-07-13.tex
%% ---------------------------------------------------------------------------
%% FROZEN HISTORICAL COPY. Superseded by principia_fractalis_millennium_problems_2026-07-13.tex.
%%
%% Retained deliberately as history. Its contents are NOT maintained and are NOT
%% patched to current language. In particular this copy predates the eight-law
%% alpha-skeleton rigidity audit of 2026-09-07 (r332, r334, r335) and therefore
%% still uses "derived", "forced" and "no free parameters" of the alpha-constants.
%% Those labels are RETIRED. The current statement is:
%%
%%   The substrate does not derive the alpha-constants; L5 is impossible through
%%   its formalized substrate-ratio channel; the other seven laws are independent
%%   of the formalized substrate assumptions; together the laws form a
%%   triangular, noncircular constraint system; therefore the constants are
%%   explicit postulates - not hidden consequences, but not an inconsistent
%%   patchwork.
%%
...
%%
%% Canonical wording: codex/CANONICAL_VERDICT_LANGUAGE_2026-09-07.md
%% Audit report:      codex/ALPHA_RIGIDITY_AUDIT_REPORT_2026-09-07.md
%%
%% Added 2026-09-07 per Pablo's ruling: header note only, nothing else changed.
%% ---------------------------------------------------------------------------
