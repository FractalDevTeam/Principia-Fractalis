...
\textbf{Result at N=600, verified end-to-end in 7 seconds runtime.} The 10 canonical $\alpha$-skeleton values emerge in the mapped spectrum at the following precisions:

\begin{center}
\begin{tabular}{lcccc}
\toprule
$\alpha$-class & target & $\alpha_{\textsf{reading}}$ & $\Delta$ & tier \\
\midrule
$\alpha_P = \sqrt{2}$ & 1.4142 & 1.4136 & $6.0\times 10^{-4}$ & $10^{-3}$ \\
$\alpha_{\textsf{Poincar\'e}} = 1$ & 1.0000 & 1.0008 & $8.4\times 10^{-4}$ & $10^{-3}$ \\
$\alpha_{\textsf{RH}} = 3/2$ & 1.5000 & 1.5020 & $2.0\times 10^{-3}$ & $10^{-2}$ \\
$\alpha_{\textsf{Hodge}} = \varphi$ & 1.6180 & 1.6160 & $2.1\times 10^{-3}$ & $10^{-2}$ \\
$\alpha_{\textsf{BSD}} = 3\pi/4$ & 2.3562 & 2.3601 & $3.9\times 10^{-3}$ & $10^{-2}$ \\
$\alpha_{\textsf{YM}} = 2$ & 2.0000 & 1.9952 & $4.8\times 10^{-3}$ & $10^{-2}$ \\
$\alpha_{\textsf{QG}} = \sqrt{2\pi}$ & 2.5066 & 2.5149 & $8.2\times 10^{-3}$ & $10^{-2}$ \\
$\alpha_{\textsf{NP}} = \varphi + \tfrac{1}{4}$ & 1.8680 & 1.8805 & $1.2\times 10^{-2}$ & $5\times 10^{-2}$ \\
$\alpha_{\textsf{HN}} = 5$ & 5.0000 & 5.0244 & $2.4\times 10^{-2}$ & $5\times 10^{-2}$ \\
$\alpha_{\textsf{NS}} = 3\pi/2$ & 4.7124 & 4.7425 & $3.0\times 10^{-2}$ & $5\times 10^{-2}$ \\
\bottomrule
\end{tabular}
\end{center}

\textbf{Score: 2/10 at $10^{-3}$ tier, 7/10 at $10^{-2}$ tier, 10/10 at $5\times 10^{-2}$ tier.} Convergence in $N$ (across $N = 200 \to 600$): YM $6.6\times 10^{-2} \to 4.8\times 10^{-3}$ (14$\times$), Hodge $2.3\times 10^{-2} \to 2.1\times 10^{-3}$ (11$\times$), HN $3.1\times 10^{-1} \to 2.4\times 10^{-2}$ (13$\times$) --- real substrate spectrum content, not single-$N$ coincidence.
