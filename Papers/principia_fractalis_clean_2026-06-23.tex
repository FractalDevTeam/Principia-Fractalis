...
\item \emph{GWTC-4.0 matches}: empirical anchors typed in \texttt{PF/Empirical/EmpiricalAnchors\_NamedSources\_2026\_06\_19.lean}; substrate-side algebraic expressions ($10\,M_\odot\cdot\alpha_1$ for the low-mass BH peak; $\alpha_3/\alpha_4 = \sqrt{2}/(\varphi+1/4)$ for the mass-ratio peak; $\kappa = \pi$ for the redshift evolution index) are direct compositions of the $\alpha$-skeleton verifiable at 60-digit precision.
