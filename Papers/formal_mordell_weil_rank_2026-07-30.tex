...
%% at HEAD d28c0d7d (2026-07-31), axioms [propext, Classical.choice,
%% Quot.sound], zero project axioms, zero sorries, no native_decide, or
%% standard cited literature. Verified build data: lake build PF = 4677
%% jobs, lake build (full) = 9339 jobs, mathlib pin eed770a4, toolchain
...
\texttt{eed770a4}. At repository HEAD \texttt{d28c0d7d}:
\lt{lake build PF} completes in $4677$ jobs and \lt{lake build} in $9339$
