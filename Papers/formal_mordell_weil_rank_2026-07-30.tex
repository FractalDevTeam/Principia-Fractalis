...
\begin{tabular}{llrr}
\toprule
point & $x(8\,\cdot)$ & $\mathcal{H}$ & bracket \\
\midrule
$P=(0,0)$   & $1169154495/76860289$ & $1169154495$ & $2^{30},2^{31}$\\
$Q=(1,0)$   & $11776563836346/9521600032681$ & $11776563836346$ & $2^{43},2^{44}$\\
$P{+}Q$     & \lt{30157844295583882647192303/13139629878047776942118401}
            & num. & $2^{84},2^{85}$\\
$P{-}Q$     & $7383740148384742954/7960116832793145801$ & den. &
              $2^{62},2^{63}$\\
\bottomrule
\end{tabular}
\end{center}
...
The files, in dependency order, are
