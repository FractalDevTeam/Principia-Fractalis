...
%% at HEAD 92cb7ab6 (2026-07-30), axioms [propext, Classical.choice,
%% Quot.sound], zero project axioms, zero sorries, no native_decide, or
%% standard cited literature. Verified build data: lake build PF = 4659
%% jobs, lake build (full) = 9303 jobs, mathlib pin eed770a4, toolchain
...
\texttt{eed770a4}. At repository HEAD \texttt{92cb7ab6}:
\lt{lake build PF} completes in $4659$ jobs and \lt{lake build} in $9303$
