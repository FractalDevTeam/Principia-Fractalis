...
\begin{tabular}{ccccc}
\toprule
$N$ & Canonical $\Delta_{\Sigma}$ & Null $p_5$ & Null median & Canonical percentile in null \\
\midrule
600  & 0.0894 & 0.0822 & 0.1854 & \textbf{6.0\%} \\
1000 & 0.0675 & 0.0609 & 0.1503 & \textbf{7.6\%} \\
1500 & 0.0308 & 0.0421 & 0.1301 & \textbf{1.5\%} \\
2000 & 0.0320 & 0.0327 & 0.1160 & \textbf{4.7\%} \\
\bottomrule
\end{tabular}
\end{center}

Canonical $\Delta_{\Sigma}$ sits at the 1.5--7.6 percentile of the null distribution across all four $N$ (bottom decile at every $N$; below null $p_5$ at $N = 1500$). Null-median decreases $0.1854 \to 0.1160$ across the same $N$ range (a real 30\% density effect --- present but subordinate). Canonical decreases faster: $0.0894 \to 0.0320$, a 64\% reduction. The canonical/null-median ratio drops from $0.48$ to $\{0.45, 0.24, 0.28\}$ --- canonical is significantly better than the density baseline and the gap widens with $N$. This rules out the density-artifact hypothesis: the substrate self-corroboration reduction is not pure spectral inflation. Eigenvalues archived at \texttt{/Storage 2TB/home/xluxx/pf\_compute/eigvals\_N\{600,1000,1500,2000\}.npy} for reproducibility of the null test.
