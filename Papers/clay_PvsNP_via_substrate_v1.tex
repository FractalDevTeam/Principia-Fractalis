...
proof is machine-verified in Lean~4 at HEAD \texttt{6adea09} of
...
The proof is machine-verified in Lean~4 at HEAD \texttt{6adea09}
...
$\{\texttt{propext},\,\texttt{Classical.choice},\,\texttt{Quot.sound}\}$.
The full build at HEAD \texttt{6adea09} reproduces the result.
