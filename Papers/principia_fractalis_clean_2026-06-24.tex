...
\end{verbatim}
The full corpus builds in approximately ten minutes ($4{,}368$ kernel-elaboration jobs at HEAD). The dedicated \texttt{PF.AxiomCheck} module prints the axiom dependencies of the four headline theorems:
\begin{itemize}[itemsep=2pt]
