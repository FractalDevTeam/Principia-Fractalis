...
```bash
cd Papers/
pdflatex principia_fractalis_millennium_problems_2026-06-29.tex
pdflatex principia_fractalis_millennium_problems_2026-06-29.tex   # for cross-references
```
