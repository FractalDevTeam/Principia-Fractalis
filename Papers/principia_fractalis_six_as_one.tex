...
$\mathbb{Q}(\sqrt{5}, \pi)$, each verified axiom-free in
...
encodings $\texttt{PF\_RHEncodingV2}, \texttt{PF\_NS3DEncoding},
...
project build of 8360 jobs at HEAD commit \texttt{b9dee31} of the
...
(of which Smale's 14th, on the Lorenz attractor, was resolved
by~\cite{tucker2002lorenz}),
