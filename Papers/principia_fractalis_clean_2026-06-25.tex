...
\paragraph{Identification with observation.} The cosmological observation is $\Lambda_{\textsf{eff}}/\Lambda_0 \sim 10^{-120}$, i.e.\ the suppression exponent is $120 \cdot \log 10 = 276.310\ldots$. The substrate's closed form gives $14079\pi/160 = 276.440\ldots$. The two agree to $0.05\%$. The residual $0.13$ on the exponent corresponds to a relative error $\Delta|R_f| \approx 5.6 \times 10^{-4}$ on the substrate-natural rational $|R_f| \approx 19/16$, exactly within the gap between $19/16$ and the Dirichlet truncation of $|R_f(\sqrt{2\pi},1)|$ at $N=200{,}000$ ($\sim 10^{-5}$ on the modulus, propagating to $\sim 0.13$ on the exponent via the chain factor $78\pi\cdot c_2 \approx 233$). A sharper substrate-natural rational closes the residual.
