...
\]
The substrate commits this prediction to public record at this paper's deposition (2026-06-25). Any subsequent measurement of $\alpha_{\textsf{GI}}$ that does not fall within $[\sqrt{2} - 10^{-4},\,\sqrt{2} + 10^{-4}]$ refutes the substrate's tri-class extension. The pre-registration timeline is Figure~\ref{fig:timeline}; the falsifier panel of which this prediction is element F5 is detailed below.
...
\node[date lab,above=2mm of e4] {\bfseries 2026-06-25 (deposition)};
...
{\textbf{Substrate's commitment} (frozen at deposition 2026-06-25): \\
