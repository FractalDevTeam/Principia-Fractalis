...
\paragraph{Primordial Li-7 deficit.} The substrate's P-class ground-state eigenvalue $\lambda_0^{(P)} = \pi/(10\sqrt{2}) = 0.22214\ldots$ matches the observed/BBN Li-7 abundance ratio~\cite{li7-deficit-2025} at $0.234 \pm 0.09$ within $0.13\sigma$, an independent cross-axis structural link between the P-class analytic eigenvalue and a long-standing cosmological anomaly.
