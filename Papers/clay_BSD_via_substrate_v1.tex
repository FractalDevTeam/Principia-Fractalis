...
Lean~4 at HEAD \texttt{6d38b41} of
...
claim above at HEAD~\texttt{6d38b41}, 8140 jobs clean, with zero
project axioms.

\section*{Note on the V2 refactor}

The referee-bridge module
\texttt{PF.Referee.BSDCapstoneTypedBridgeV2}
strengthens the BSD typed bridge used in the proof above by routing
the algebraic and analytic rank witnesses through named typed
predicates.  The V2 module supplies the routing lemmas
\texttt{algebraicRankV2\_routed\_via\_RankWitnessTyped} and
\texttt{analyticRankV2\_routed\_via\_SelmerRankEquals}, a
typed-rank-equality theorem
\texttt{algebraicRankV2\_eq\_analyticRankV2}, and the V2-level
capstone
\texttt{PF\_BSD\_capstone\_yields\_Clay\_BSD\_standardV2}
together with the back-compatibility lemma
\texttt{PF\_BSD\_capstoneV2\_implies\_V1}.  The V2 refactor is
